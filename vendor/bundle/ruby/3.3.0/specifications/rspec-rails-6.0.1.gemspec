...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.11".freeze])
  s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.11".freeze])
  s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.11".freeze])
  s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.11".freeze])
